			...
			if (ModelState.IsValid)
			{
				...
				switch (result)
				{
					case SignInStatus.Success:
						resultData = new { Status = "Success", Email = model.Email };
						break;
					case SignInStatus.LockedOut:
						resultData = new { Status = "Locked", Email = model.Email };
						break;
					case SignInStatus.RequiresVerification:
						resultData = new { Status = "RequiresVerification", Email = model.Email };
						break;
					case SignInStatus.Failure:
						resultData = new { Status = "Failure", Email = model.Email };
						break;
				}
			}
			else
